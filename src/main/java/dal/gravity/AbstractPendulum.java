...
public abstract class AbstractPendulum {
     ...
     */
    public AbstractPendulum (double inLength, double inMass, double inTheta0, GravityModel inGravityModel) {
	...
	if (validGC (inGravityModel.getGravitationalField ())) gravityModel = inGravityModel;
	else throw new IllegalArgumentException 
